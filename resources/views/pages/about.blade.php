...
@section('content')
  <div id="contenido" style="background-image: url({{asset('img/aboutBackground.jpg')}})">
    <div class="titulo1" id="textonosotros">
      <p><span class="titulo2">Acerca </span><span class="titulo3">de Nosotros</span><br />
        <br />
       <p class="textos"> Somos una empresa de gerencia organizada para el desarrollo de inmuebles para la clase media panameña y latinoamericana que desean invertir con rendimiento sostenido y creciente.Está integrada por gerentes panameños (Grupo Rical) y venezolanos (Grupo Trom) que han dedicado su vida de trabajo a desarrollos inmobiliarios durante más de 30 años.<br /><br />
  Cuenta con profesionales dedicados al negocio inmobiliario y se enfoca en optimizar el retorno de la inversión de nuestros socios a través de un diverso y amplio portafolio de bienesraices además de ofrecer viviendas de interés social en la Ciudad de Panamá.
  Gerencias Gal, posee gran conocimiento en gestión de inversiones y expertos en transacciones, en mercados ya establecidos y emergentes. Ofreciendo un insuperable servicio al cliente, con integridad y una total transparencia.</p>
  <p>&nbsp;</p>
    </div>
  ...
  <div id="titulonosotros">
    ...
    <p class="titulo3">¿Quiénes integran Grupo Gal?</p>
  ...
  <p class="textos"><br />
      ...
      <div id="ricaltxt">
        ...
        <p class="textos">El grupo se ha diversificado exitosamente en  diferentes inversiones, llenando así las expectativas de acuerdo con el  desarrollo económico del país.<br />
